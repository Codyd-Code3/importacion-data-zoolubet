...
# PROGRAMA USADO PARA AÑADIR LA ETIQUETA Unidades COLUMNA COSTO 
...
with open('1_sacar_proovedores (eliminacion).csv', 'r', encoding='utf-8') as archivo_original, open('2_agregar_columna_tipo.csv', 'w', newline='', encoding='utf-8') as archivo_nuevo:
    ...
    cabecera.append('tipo de compañia')
