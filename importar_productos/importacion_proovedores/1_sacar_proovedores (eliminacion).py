...
with open('limpio.csv', 'r', encoding='utf-8') as archivo_original, open('1_sacar_proovedores (eliminacion).csv', 'w', newline='', encoding='utf-8') as archivo_nuevo:
    ...
    cabecera.append('proovedores-unicos')
    #print("\ncabecera 2:", cabecera)
    ...
    for i, fila in enumerate(lector_csv):
        ...
        if contador < 5000:
            ...
            if not valor_padre_hijo in categorias_padre_e_hijo:
                ...
                #if fila[15] != '':
                categorias_padre_e_hijo.append(fila[6])

                nueva_fila = fila + [fila[6]]
